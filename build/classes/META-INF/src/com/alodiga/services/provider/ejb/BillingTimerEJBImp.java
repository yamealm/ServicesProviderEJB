...
import com.alodiga.services.provider.commons.ejbs.BillingTimerEJBLocal;
...
@Stateless(name = EjbConstants.BILLING_TIMER_EJB, mappedName = EjbConstants.BILLING_TIMER_EJB)

@TransactionManagement(TransactionManagementType.BEAN)
public class BillingTimerEJBImp extends AbstractSPEJB  implements BillingTimerEJB, BillingTimerEJBLocal{

    private static final Logger logger = Logger.getLogger(BillingTimerEJBImp.class);
     @EJB
    private BillingsEJBLocal BillingsEJBLocal;
    ...
    private void createTimer() {
        ctx.getTimerService().createTimer(initialExpiration.getTime(), timeoutInterval, EjbConstants.BILLINGS_EJB);
}
